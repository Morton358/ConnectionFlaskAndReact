...
def calculation():
    ...
    for iteratorR in range(data["i3r3e5"].R):
        temporary5 = (
            (sumColumn(data["i3r3e5"].A1_R__1_I, iteratorR) - data["i3r3e5"].Z1_R[iteratorR]) / data["i3r3e5"].V[
            iteratorR]
    ...
    if count == ((data["i3r3e5"].I + data["i3r3e5"].E) * data["i3r3e5"].R) and \
        allCount == (
        (((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2) * data["i3r3e5"].R):
    ...
    if len(nonZeroCoeficients) == (
        ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) +  # constraint 7
    ...
    return {"I" : data["i3r3e5"].I,
            ...
            "Vr" : data["i3r3e5"].V,
            "Zr" : data["i3r3e5"].Z1_R,
            "Air" : data["i3r3e5"].A1_R__1_I_arr,
            "Are" : data["i3r3e5"].A1_R__1_E_arr,
            "Jir": data["i3r3e5"].J1_R__1_I_arr,
            "Jre": data["i3r3e5"].J1_R__1_E_arr,
            "Z" : data["i3r3e5"].Z,
            "Y" : data["i3r3e5"].Y,
            "Q_TIR" : data["i3r3e5"].Q_TIR,
            "Q" : data["i3r3e5"].Q,
            "Ji" : data["i3r3e5"].J1_I,
            "Jr" : data["i3r3e5"].J1_R,
            "Mir" : data["i3r3e5"].M1_R__1_I,
            "Mre": data["i3r3e5"].M1_R__1_E,
            "objective" : dObj[0],
            "primalSolutions" : primalSol }
